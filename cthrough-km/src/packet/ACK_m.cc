...
{
    this->srcTor = other.srcTor;
    this->destTor = other.destTor;
}

void ACK::parsimPack(omnetpp::cCommBuffer *b) const
{
    ::omnetpp::cMessage::parsimPack(b);
    doParsimPacking(b,this->srcTor);
    doParsimPacking(b,this->destTor);
}

void ACK::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::omnetpp::cMessage::parsimUnpack(b);
    doParsimUnpacking(b,this->srcTor);
    doParsimUnpacking(b,this->destTor);
}

int ACK::getSrcTor() const
{
    return this->srcTor;
}

void ACK::setSrcTor(int srcTor)
{
    this->srcTor = srcTor;
}

int ACK::getDestTor() const
{
    return this->destTor;
}

void ACK::setDestTor(int destTor)
{
    this->destTor = destTor;
}
...
ACKDescriptor::ACKDescriptor() : omnetpp::cClassDescriptor("ACK", "omnetpp::cMessage")
{
...
int ACKDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='s' && strcmp(fieldName, "srcTor")==0) return base+0;
    if (fieldName[0]=='d' && strcmp(fieldName, "destTor")==0) return base+1;
...
std::string ACKDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    ACK *pp = (ACK *)object; (void)pp;
    switch (field) {
        case 0: return long2string(pp->getSrcTor());
        case 1: return long2string(pp->getDestTor());
        default: return "";
    }
}
...
bool ACKDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    ACK *pp = (ACK *)object; (void)pp;
    switch (field) {
        case 0: pp->setSrcTor(string2long(value)); return true;
        case 1: pp->setDestTor(string2long(value)); return true;
