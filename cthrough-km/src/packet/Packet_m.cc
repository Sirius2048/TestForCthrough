...
void Packet::copy(const Packet& other)
{
    ...
    this->srcRack = other.srcRack;
    this->destAddr = other.destAddr;
    this->destRack = other.destRack;
...
void Packet::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->srcRack);
    doParsimPacking(b,this->destAddr);
    doParsimPacking(b,this->destRack);
...
void Packet::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->srcRack);
    doParsimUnpacking(b,this->destAddr);
    doParsimUnpacking(b,this->destRack);
...
int Packet::getSrcRack() const
{
    return this->srcRack;
}

void Packet::setSrcRack(int srcRack)
{
    this->srcRack = srcRack;
}
...
int Packet::getDestRack() const
{
    return this->destRack;
}

void Packet::setDestRack(int destRack)
{
...
int Packet::getVlan() const
{
    return this->vlan;
}

void Packet::setVlan(int vlan)
{
    this->vlan = vlan;
}
...
void Packet::setFlowId(int flowId)
{
    this->flowId = flowId;
}

int Packet::getPkId() const
{
    return this->pkId;
}

void Packet::setPkId(int pkId)
{
    this->pkId = pkId;
}
...
int PacketDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='s' && strcmp(fieldName, "srcRack")==0) return base+1;
    if (fieldName[0]=='d' && strcmp(fieldName, "destAddr")==0) return base+2;
    if (fieldName[0]=='d' && strcmp(fieldName, "destRack")==0) return base+3;
    if (fieldName[0]=='h' && strcmp(fieldName, "hopCount")==0) return base+4;
    if (fieldName[0]=='v' && strcmp(fieldName, "vlan")==0) return base+5;
    if (fieldName[0]=='f' && strcmp(fieldName, "flowId")==0) return base+6;
    if (fieldName[0]=='p' && strcmp(fieldName, "pkId")==0) return base+7;
...
std::string PacketDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 1: return long2string(pp->getSrcRack());
        case 2: return long2string(pp->getDestAddr());
        case 3: return long2string(pp->getDestRack());
        case 4: return long2string(pp->getHopCount());
        case 5: return long2string(pp->getVlan());
        case 6: return long2string(pp->getFlowId());
        case 7: return long2string(pp->getPkId());
        default: return "";
    }
}
...
bool PacketDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 1: pp->setSrcRack(string2long(value)); return true;
        case 2: pp->setDestAddr(string2long(value)); return true;
        case 3: pp->setDestRack(string2long(value)); return true;
        case 4: pp->setHopCount(string2long(value)); return true;
        case 5: pp->setVlan(string2long(value)); return true;
        case 6: pp->setFlowId(string2long(value)); return true;
        case 7: pp->setPkId(string2long(value)); return true;
